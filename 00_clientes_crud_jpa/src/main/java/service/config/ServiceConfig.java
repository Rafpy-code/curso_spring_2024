...
@EnableJpaRepositories(basePackages = "models.dao",entityManagerFactoryRef = "factory",transactionManagerRef = "txManager")
@EnableTransactionManagement //habilita la transaccionalidad usando anotación @Transactional
@ComponentScan(basePackages = {"models.service"})
@Configuration
public class ServiceConfig {
	String driver="com.mysql.cj.jdbc.Driver";
	String cadena="jdbc:mysql://localhost:3306/db_clientes_ag";
	String usuario="root";
	String pw="root";
	...
	public LocalContainerEntityManagerFactoryBean factory() {
		...
		factory.setPersistenceUnitName("clientesPU");
